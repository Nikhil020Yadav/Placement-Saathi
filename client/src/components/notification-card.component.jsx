...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    const handleDeleteClick = (comment_id, type, target) => {
        ...
        axios.post(import.meta.env.VITE_SERVER_URL + "/delete-comment", { _id: comment_id }, {
            headers: {
            ...
            .then(() => {
                ...
                setNotifications({ ...notifications, results, totalDocs: totalDocs - 1, deletedDocCnt: notifications.deletedDocCnt + 1 })
            })
            .catch((err) => {
                console.log(err);
        ...
        <div className={"p-6 border-b border-grey border-l-black " + (!seen ? "border-l-2" : "")}>
            <div className="flex gap-5 mb-3">
                ...
                <div className="w-full">
                    <h1 className="font-medium text-xl text-black-100">
...

            {
                ...
                reply ?
                    <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                        ...
                        <button className="underline hover:text-black ml-14 mt-2" onClick={(e) => handleDeleteClick(reply._id, "reply", e.target)}> Delete </button>
                    </div>
                    : ""
            }
        </div>
