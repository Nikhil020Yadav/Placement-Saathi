...
const Navbar = () => {
    ...
    useEffect(() => {
        if (access_token) {
            axios.get(import.meta.env.VITE_SERVER_URL + "/new-notification", {
                headers: {
    ...
    return (
        <>
            <nav className="navbar flex items-center justify-between p-4 relative z-50">
                ...
                <div className='flex items-center gap-3 md:gap-6 ml-auto'>
                    ...
                    <button className='w-12 h-12 rounded-full bg-grey relative hover:bg-black/10 text-2xl block mt-1' onClick={changeTheme}>
